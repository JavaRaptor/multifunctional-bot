...
exports.run = (client, message, args) =>
{
    ...
    } else
    {
        let embed = new Discord.MessageEmbed()
            ...
            .addField("Administration", "`ban`,`kick`,`warn`,`setlang`")
            .addField("User", "`bug`,`user`,`help`,`stats`,`bl-report`")
            .addField("Rpg", "`profile`,`level`")
            .addField("Owner", "`reload`,`dm`,`eval`,`restart`,`bl-add`,`bl-del`")
            .setDescription("[Serveur Support](https://discord.gg/k8YzNr9sf6) | [Invite Bot](https://discord.com/api/oauth2/authorize?client_id=702659084716998757&permissions=8&scope=bot)")
        message.channel.send(embed);
    }
}
